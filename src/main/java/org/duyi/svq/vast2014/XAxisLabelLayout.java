 ...
 * @date	2014年6月22日
 */
public class XAxisLabelLayout extends Layout {

    public static final String FRAC = "frac";
    public static final String LABEL = "_label";
    public static final String VALUE = "_value";
    
    private XAxisLayout2 m_layout; // pointer to matching layout, if any
     ...
     */
    public XAxisLabelLayout(String group, int axis, ValuedRangeModel values)
    {
     ...
     */
    public XAxisLabelLayout(String group, XAxisLayout2 layout) {
     ...
     * @param bounds the layout bounds within which to place the axis marks
     */
    public XAxisLabelLayout(String group, XAxisLayout2 layout, Rectangle2D bounds) {
...
//        	System.out.println(model.getObject(v).toString().substring(0, 7));
            if ( (r=index.get((double)v)) >= 0 ) {
                VisualItem item = labels.getItem(r);
                item.set(VisualItem.LABEL, model.getObject(v).toString().substring(0, 7));
                item.setVisible(true);
                item.setEndVisible(true);
            } else {
                VisualItem item = labels.addItem();
